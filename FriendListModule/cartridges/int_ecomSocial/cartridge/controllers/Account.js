...
server.replace(
    ...
    function (req, res, next) {
        ...
        var registrationFormObj = {
            ...
            birthDate: new Date(registrationForm.customer.birthDate.value),
                    ...
                    try {
                        Transaction.wrap(function () {
                            ...
                            if (!authenticatedCustomer) {
                                ...
                                newCustomerProfile.birthday = registrationForm.birthDate;
                                newCustomerProfile.email = registrationForm.email;
                                var a = customer_number;
                                if(customer_number){
                                    var customer_profile = CustomerMgr.getCustomerByCustomerNumber(customer_number);
                                    customer_profile.profile.custom.userWallet += 5; 
                                }
                            }
                        });
                    } catch (e) {
...
server.replace(
    ...
    function (req, res, next) {
        ...
        profileForm.customer.birthDate.value = accountModel.profile.birthday;
